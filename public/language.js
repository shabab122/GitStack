(() => {
  ...
  Object.assign(exact, {
    ...
    "GitStack supports instructor-created dynamic missions with repository-state validation rules.": "GitStack শিক্ষক-তৈরি ডাইনামিক মিশন এবং রিপোজিটরি-স্টেট ভ্যালিডেশন রুল সমর্থন করে।",
    ...
    "Team membership, roles, Gitea repositories, Pull Requests, review events and team scoring are integrated into the collaboration workflow.": "টিম সদস্যপদ, ভূমিকা, Gitea রিপোজিটরি, Pull Request, রিভিউ ইভেন্ট এবং টিম স্কোরিং সহযোগিতা ওয়ার্কফ্লোতে একীভূত।",
    ...
    /* V15 dynamic missions, ranking, teams and theme */
    "XP leaderboard": "XP লিডারবোর্ড",
    "Codeforces-inspired ranking based on real GitStack XP.": "বাস্তব GitStack XP-এর ভিত্তিতে Codeforces-অনুপ্রাণিত র‍্যাঙ্কিং।",
    "Top 5 earn milestone badges": "শীর্ষ ৫ জন মাইলস্টোন ব্যাজ পায়",
    "Top rated": "শীর্ষ রেটেড",
    "XP ranking": "XP র‍্যাঙ্কিং",
    "Top contributors": "শীর্ষ অবদানকারী",
    "Verified activity score": "যাচাইকৃত কার্যক্রম স্কোর",
    "View all": "সব দেখুন",
    "Show top 10": "শীর্ষ ১০ দেখুন",
    "Rank": "র‍্যাঙ্ক",
    "Milestone": "মাইলস্টোন",
    "Contribution": "অবদান",
    "Contribution score": "অবদান স্কোর",
    "Diamond": "ডায়মন্ড",
    "Platinum": "প্লাটিনাম",
    "Gold": "গোল্ড",
    "Silver": "সিলভার",
    ...
    "Edit mission": "মিশন সম্পাদনা করুন",
    "Dynamic mission builder and validation": "ডায়নামিক মিশন বিল্ডার ও ভ্যালিডেশন",
    "DYNAMIC CURRICULUM": "ডায়নামিক কারিকুলাম",
    "Mission catalogue": "মিশন ক্যাটালগ",
    "Create, publish and manage Git missions from the instructor dashboard. Existing system missions remain available while new individual missions can use configurable repository-state validation.": "ইন্সট্রাক্টর ড্যাশবোর্ড থেকে Git মিশন তৈরি, প্রকাশ ও পরিচালনা করুন। বিদ্যমান সিস্টেম মিশন থাকবে এবং নতুন ব্যক্তিগত মিশনে কনফিগারযোগ্য রিপোজিটরি-স্টেট ভ্যালিডেশন ব্যবহার করা যাবে।",
    "Create, publish and manage GitStack missions and performance.": "GitStack মিশন ও পারফরম্যান্স তৈরি, প্রকাশ ও পরিচালনা করুন।",
    "Mission title": "মিশনের শিরোনাম",
    "Slug (optional)": "স্লাগ (ঐচ্ছিক)",
    "Mission type": "মিশনের ধরন",
    "Level": "লেভেল",
    "XP reward": "XP পুরস্কার",
    "Estimated minutes": "আনুমানিক মিনিট",
    "Objective": "উদ্দেশ্য",
    "Mission steps — one objective step per line": "মিশন ধাপ — প্রতি লাইনে একটি উদ্দেশ্যভিত্তিক ধাপ",
    "Student-facing command suggestions are intentionally not shown.": "শিক্ষার্থীদের জন্য কমান্ড সাজেশন ইচ্ছাকৃতভাবে দেখানো হয় না।",
    "Automatic validation rules": "স্বয়ংক্রিয় ভ্যালিডেশন নিয়ম",
    "Repository must be initialized": "রিপোজিটরি ইনিশিয়ালাইজ করতে হবে",
    "Required file": "প্রয়োজনীয় ফাইল",
    "Required file must be tracked": "প্রয়োজনীয় ফাইল Git-এ ট্র্যাক করতে হবে",
    "Minimum commits": "ন্যূনতম কমিট",
    "Minimum latest commit message length": "সর্বশেষ কমিট মেসেজের ন্যূনতম দৈর্ঘ্য",
    "Required branch prefix": "প্রয়োজনীয় ব্রাঞ্চ প্রিফিক্স",
    "Finish on branch": "যে ব্রাঞ্চে শেষ করতে হবে",
    "Working tree must be clean": "ওয়ার্কিং ট্রি ক্লিন হতে হবে",
    "Publish mission": "মিশন প্রকাশ করুন",
    "Published missions become visible to students and available for assignments.": "প্রকাশিত মিশন শিক্ষার্থীদের কাছে দৃশ্যমান হবে এবং অ্যাসাইনমেন্টে ব্যবহার করা যাবে।",
    "Save mission": "মিশন সংরক্ষণ করুন",
    "System mission": "সিস্টেম মিশন",
    "Form your own team": "নিজের টিম তৈরি করুন",
    "Students may form their own eligible three-person team. Rankings and XP can help you identify active teammates.": "শিক্ষার্থীরা নিজেরাই যোগ্য তিন সদস্যের টিম তৈরি করতে পারে। সক্রিয় টিমমেট বাছাইয়ে র‍্যাঙ্কিং ও XP সহায়তা করতে পারে।",
    "Dark": "ডার্ক",
    "Light": "লাইট",
    "Dark mode": "ডার্ক মোড",
    "Light mode": "লাইট মোড",
    ...
    "Assign published individual or team missions and manage due dates.": "প্রকাশিত ব্যক্তিগত বা টিম মিশন অ্যাসাইন করুন এবং ডিউ ডেট পরিচালনা করুন।",
    "Create instructor teams, review student-formed teams and manage collaboration roles.": "ইন্সট্রাক্টর টিম তৈরি করুন, শিক্ষার্থীদের তৈরি টিম পর্যালোচনা করুন এবং সহযোগিতার ভূমিকা পরিচালনা করুন।",
    "Student-formed": "শিক্ষার্থী-গঠিত",
    "Created by you": "আপনার তৈরি",
    "Instructor-created": "ইন্সট্রাক্টর-গঠিত",
